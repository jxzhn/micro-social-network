...
async function clickLike(likeElement, i) {
    ...
    var likeInfo = {
        postId: loadedTweetList[i].id
    }
    if(tweet.liked){
        try{
            console.log("send to /user/dislike:");
            console.log(likeInfo);
            if(!TEST_FLAG)await ajax.post("/user/dislike", likeInfo);
        }
        catch(err){
            console.log(err);
        }
        ...
        try{
            console.log("send to /user/like:");
            console.log(likeInfo);
            if(!TEST_FLAG)await ajax.post("/user/like", likeInfo);
        }
        catch(err){
            console.log(err);
        }
